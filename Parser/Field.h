...
public:
    ...
    {
        if (scale != r.getScale())
            throw Exception("Add different decimal fields");
        dec += r.getValue();
        return *this;
    }
    ...
    {
        if (scale != r.getScale())
            throw Exception("Sub different decimal fields");
        dec -= r.getValue();
        return *this;
    }
...
public:
    struct Types
    {
        ...
        static const char * toString(Which which)
        {
            ...
            throw Exception("Bad type of Field");
        }
    };
...
//            case Types::Decimal128: return f(field.template get<DecimalField<Decimal128>>());
            ...
            case Types::Int128:
                ...
                throw Exception("Unexpected Int128 in Field::dispatch()");
        }
...
//        Null, UInt64, UInt128, Int64, Int128, Float64, String, Array, Tuple,
        Null, UInt64, Int64, Float64, String, Array, Tuple,
//        DecimalField<Decimal32>, DecimalField<Decimal64>, DecimalField<Decimal128>, AggregateFunctionStateData
        DecimalField<Decimal32>, DecimalField<Decimal64>, AggregateFunctionStateData
        > storage;
...
[[noreturn]] inline void readText(Array &, ReadBuffer &) { throw Exception("Cannot read Array."); }
[[noreturn]] inline void readQuoted(Array &, ReadBuffer &) { throw Exception("Cannot read Array."); }
...
[[noreturn]] inline void readText(Tuple &, ReadBuffer &) { throw Exception("Cannot read Tuple."); }
[[noreturn]] inline void readQuoted(Tuple &, ReadBuffer &) { throw Exception("Cannot read Tuple."); }
